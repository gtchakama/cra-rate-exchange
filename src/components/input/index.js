    ...
    <div className="row">
      <div className=" ">
        <div className="mb-3 w-96">
          <div className="input-group relative flex  items-stretch  mb-4 w-full text-xl p-4 border my-4 rounded border-gray-300 focus:outline-none focus:border-indigo-500">
            <input
              type={passwordType}
